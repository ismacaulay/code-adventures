...
// repr allows us to represent each cell as a single byte
#[wasm_bindgen]
#[repr(u8)]
...
impl Universe {
        ...
        for row in 0..self.height {
            for col in 0..self.width {
                ...
                let next_cell = match (cell, live_neighbors) {
                    ...
                    // Rule 3: any dead cell with exactly 3 neighbors becomes alive
    ...
    fn live_neighbor_count(&self, row: u32, col: u32) -> u8 {
        ...
        // use self.height - 1 to subtract by -1, letting the modulo operator
        // handle the subtraction to prevent unsigned integer underflow
