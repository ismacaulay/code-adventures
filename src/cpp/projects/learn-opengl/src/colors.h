...
public:
    ...
    void attach(tk::engine::Engine& engine) override
    {
        ...
        camera_controller_->set_position({ 0.0f, 0.0f, 5.0f });
        ...
        cube_shader_ = tk::engine::Shader::from_file(
            "assets/shaders/cube.vert", "assets/shaders/cube.frag");
        cube_shader_->bind();
        ...
        light_model_ = glm::translate(light_model_, { 1.2f, 1.0f, 2.0f });
